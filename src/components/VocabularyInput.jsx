  ...
  return (
    <div className="container">
      ...
      <header>
        ...
        <h1>Quizlet Vocabulary Manager</h1>
      ...
      <div className="app-content">
        <div className="instructions">
          ...
          <ul>
            ...
            <li>When your list is complete, export it for use in your Quizlet matching game</li>
          </ul>
        </div>
      ...
      <footer>
        <p>Quizlet Vocabulary Manager &copy; 2023 | Part of the Enhanced Quizlet Matching Project</p>
      </footer>
    </div>
  );
};
